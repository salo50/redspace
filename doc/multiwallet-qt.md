...
In order to support loading of multiple wallets in redspace-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is redspace.cpp.
...
Changes to redspace.cpp
----------------------
redspace.cpp is the entry point into redspace-qt, and as such, will require some minor modifications to provide hooks for
