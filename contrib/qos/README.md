...
This means one can have an always-on redspaced instance running, and another local redspaced/redspace-qt instance which connects to this node and receives blocks from it.
