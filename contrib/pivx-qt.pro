...
RESOURCES += src/qt/redspace.qrc src/qt/redspace_locale.qrc

TRANSLATIONS += src/qt/locale/redspace_bg.ts \
                src/qt/locale/redspace_de.ts \
                src/qt/locale/redspace_en.ts \
                src/qt/locale/redspace_es.ts \
                src/qt/locale/redspace_fi.ts \
                src/qt/locale/redspace_fr.ts \
                src/qt/locale/redspace_it.ts \
                src/qt/locale/redspace_ja.ts \
                src/qt/locale/redspace_pl.ts \
                src/qt/locale/redspace_pt.ts \
                src/qt/locale/redspace_ru.ts \
                src/qt/locale/redspace_sk.ts \
                src/qt/locale/redspace_sv.ts \
                src/qt/locale/redspace_vi.ts \
                src/qt/locale/redspace_zh_CN.ts \
                src/qt/locale/redspace_zh_TW.ts
