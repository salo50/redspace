                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRSCPathCustom = GetArg("-zrscbackuppath", "");
    ...
    if(!strzRSCPathCustom.empty()) {
        ui->wallet_customzrscbackuppath->setText(QString::fromStdString(strzRSCPathCustom));
        ui->wallet_customzrscbackuppath_label->setVisible(true);
        ui->wallet_customzrscbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRSCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the redspace RPC console.") + "<br>" +
