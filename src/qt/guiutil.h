...
/** Utility functions used by the redspace Qt UI.
 */
namespace GUIUtil
{
...
// Render redspace addresses in monospace font
...
// Parse "redspace:" URI into recipient object, return true on successful parsing
