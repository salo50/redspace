...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("redspace Core"),
     ...
     * override -datadir in the redspace.conf file in the default data directory
     * (to be consistent with redspaced behavior)
     */
    if (dataDir != getDefaultDataDirectory())
