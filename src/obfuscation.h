...
{
public:
    /// Is the inputs associated with this public key? (and there is 20000 RSC - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of redspace.
