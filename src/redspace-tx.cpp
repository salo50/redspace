...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("RedSpace Core redspace-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  redspace-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded redspace transaction") + "\n" +
                               "  redspace-tx [options] -create [commands]   " + _("Create hex-encoded redspace transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded redspace transaction
