...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop redspace server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "redspace server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* redspace features */
        {"redspace", "listmasternodes", &listmasternodes, true, true, false},
        {"redspace", "getmasternodecount", &getmasternodecount, true, true, false},
        {"redspace", "masternodeconnect", &masternodeconnect, true, true, false},
        {"redspace", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"redspace", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"redspace", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"redspace", "masternodecurrent", &masternodecurrent, true, true, false},
        {"redspace", "masternodedebug", &masternodedebug, true, true, false},
        {"redspace", "startmasternode", &startmasternode, true, true, false},
        {"redspace", "createmasternodekey", &createmasternodekey, true, true, false},
        {"redspace", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"redspace", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"redspace", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"redspace", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"redspace", "getmasternodescores", &getmasternodescores, true, true, false},
        {"redspace", "preparebudget", &preparebudget, true, true, false},
        {"redspace", "submitbudget", &submitbudget, true, true, false},
        {"redspace", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"redspace", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"redspace", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"redspace", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"redspace", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"redspace", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"redspace", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"redspace", "checkbudgets", &checkbudgets, true, true, false},
        {"redspace", "mnsync", &mnsync, true, true, false},
        {"redspace", "spork", &spork, true, true, false},
        {"redspace", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzrscseed", &getzrscseed, false, false, true},
        {"zerocoin", "setzrscseed", &setzrscseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzrsc", &searchdzrsc, false, false, true},
        {"zerocoin", "dzrscstate", &dzrscstate, false, false, true},
...
{
    return "> redspace-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:52249/\n";
}
