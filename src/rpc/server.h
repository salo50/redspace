...
/**
 * redspace RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzrscseed(const UniValue& params, bool fHelp);
extern UniValue getzrscseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzrsc(const UniValue& params, bool fHelp);
extern UniValue dzrscstate(const UniValue& params, bool fHelp);
