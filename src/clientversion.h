...
#error Client version information missing: version is not defined by redspace-config.h or in any other way
#endif
...
/**
 * redspaced-res.rc includes this file, but it cannot cope with real c++ code.
