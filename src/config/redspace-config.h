/* src/config/redspace-config.h.  Generated from redspace-config.h.in by configure.  */
/* src/config/redspace-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.redspace.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "RedSpace Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RedSpace Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "redspace"
