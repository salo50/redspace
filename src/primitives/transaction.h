...
public:
    ...
    {
        // "Dust" is defined in terms of CTransaction::minRelayTxFee, which has units ursc-per-kilobyte.
        // If you'd pay more than 1/3 in fees to spend something, then we consider it dust.
        // A typical txout is 34 bytes big, and will need a CTxIn of at least 148 bytes to spend
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 20000 ursc per kB
        // and that means that fee per txout is 182 * 20000 / 1000 = 1820 ursc.
        // So dust is a txout less than 1820 *3 = 5460 ursc
        // with default -minrelaytxfee = minRelayTxFee = 20000 ursc per kB.
