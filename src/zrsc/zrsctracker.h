...
#ifndef redspace_ZRSCTRACKER_H
#define redspace_ZRSCTRACKER_H
...
public:
    CzRSCTracker(std::string strWalletFile);
    ~CzRSCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzRSCWallet* zRSCWallet = NULL);
