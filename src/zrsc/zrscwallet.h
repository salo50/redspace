...
#ifndef redspace_ZRSCWALLET_H
#define redspace_ZRSCWALLET_H
...
public:
    CzRSCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRSC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRSC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
