...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 52250;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // redspace starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // redspace: 1 day
        nTargetSpacing = 1 * 60;  // redspace: 1 minute
        nMaturity = 19; //159
        ...
        vSeeds.push_back(CDNSSeedData("209.250.241.85","209.250.241.85"));     // offline
        vSeeds.push_back(CDNSSeedData("45.77.67.47","45.77.67.47"));    //  offline
        ...
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0x31)(0x25)(0x21).convert_to_container<std::vector<unsigned char> >();
        ...
        nStartMasternodePayments = 1562155200; //Wed, 25 Jun 2014 20:36:16 GMT
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zrsc to be stakable
...
public:
	...
	//MineGenesis(genesis);
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "redspace-testnet.seed.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "redspace-testnet.seed2.fuzzbawls.pw"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet redspace addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet redspace script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet redspace BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet redspace BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet redspace BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // redspace: 1 day
        nTargetSpacing = 1 * 60;        // redspace: 1 minutes
        ...
        genesis.nTime = 1562155202;
        genesis.nNonce = 1158687;
	//MineGenesis(genesis);
        hashGenesisBlock = genesis.GetHash();
