Contributing to redspace Core
============================

The redspace Core project operates an open contributor model where anyone is
...
The following applies to code changes to the redspace Core project, and is not to be
confused with overall redspace Network Protocol consensus changes.

Whether a pull request is merged into redspace Core rests with the project merge
...
Patches that change redspace consensus rules are considerably more involved than
...
Where a patch set proposes to change the redspace consensus, it must have been
...
The project leader is the release manager for each redspace Core release.
